...
**Implication for quipuu:** All deprecation/disallow years below are from the IPD. They may change in the final. Monitor https://csrc.nist.gov/pubs/ir/8547 for a non-IPD URL to appear.
...
### 2.3 Security Strength to Key-Size Mapping (for quipuu classifier)
...
### 8.2 Algorithm-to-Level Mapping for quipuu
...
## 9. DECISIONS — quipuu Risk Engine
