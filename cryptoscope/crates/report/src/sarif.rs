...
//! * Cross-ref CBOM via `properties."cryptoscope/cbom-ref"` on each result.
    ...
    for finding in findings {
        ...
        let rule = json!({
            ...
            "properties": {
                ...
                "cryptoscope/algorithm-id": algo_id,
                "cryptoscope/quantum-status": quantum_status,
