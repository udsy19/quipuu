...
use cryptoscope_core::{AlgorithmRecord, AlgorithmTable, Finding, Primitive, QuantumStatus};
use thiserror::Error;
use uuid::Uuid;
...
pub fn emit_cbom(
    ...
    let bom = Bom {
        ...
        metadata: Some(Metadata {
            ...
            tools: vec![Tool {
                vendor: Some("cryptoscope".into()),
                name: "cryptoscope".into(),
                version: env!("CARGO_PKG_VERSION").to_owned(),
            }],
            component: Some(Component {
                component_type: ComponentType::Application,
                bom_ref: Some("cryptoscope/scan-target".into()),
