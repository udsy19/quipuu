//! cryptoscope-scan-network — TLS endpoint probe.
//!
...
//!   * Cert-chain findings via the existing [`cryptoscope_scan_certs`] crate.
//!   * One [`cryptoscope_core::Finding`] per probe outcome (Accepted / Rejected / Timeout).
//!
