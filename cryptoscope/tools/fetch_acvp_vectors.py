...
inside the cryptoscope binary via `include_bytes!`. The compiled binary never
...
cryptoscope's runner consumes a SINGLE merged file per (algorithm, parameterSet,
...
# (subset of parameter sets cryptoscope's runner supports today)
TARGETS = [
    {
