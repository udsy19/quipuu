...
- **Broader language coverage:** the Go rule pack is the least developed among the four largest packs today (93 classify arms vs. Java's 167, C/C++'s 114, and C#'s 115 — C/C++ grew past its earlier last-place position via the OpenSSL/liboqs PQC keygen and fetch coverage added across cycles 44–61). Expanding Go classify rules is the highest-leverage near-term coverage move.
