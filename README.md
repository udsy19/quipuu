...
Audit-validated precision: **97.12%** (95% CI: 95.8%–98.4%) — measured 2026-08-30 on **635 audited findings** out of 1970, every one labelled by opening its cited `file:line`. Methodology, the full label set and per-finding verdicts are in `BENCHMARKING_RESULTS.md`, `PRECISION_AUDIT_V4.md` and `PRECISION_AUDIT_V3.md`.
...
| Published precision (crypto findings) | 97.12% (635 audited rows, DEPENDS excluded) | ~49–76% (published benchmarks) | High (full data-flow) | Not published | Not published |
