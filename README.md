...
Audit-validated precision: **97.17%** (95% CI: 95.9%–98.5%) — measured 2026-08-30 on **640 audited findings** out of 1694, every one labelled by opening its cited `file:line`. Methodology, the full label set and per-finding verdicts are in `BENCHMARKING_RESULTS.md`, `PRECISION_AUDIT_V4.md` and `PRECISION_AUDIT_V3.md`.
...
| Published precision (crypto findings) | 97.17% (640 audited rows, DEPENDS excluded) | ~49–76% (published benchmarks) | High (full data-flow) | Not published | Not published |
