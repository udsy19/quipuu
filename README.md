...
| Published precision (crypto findings) | 90.4% (194 audited rows, DEPENDS excluded) | ~49–76% (published benchmarks) | High (full data-flow) | Not published | Not published |
