...
Audit-validated precision: **97.25%** (95% CI: 96.0%–98.5%) — measured 2026-08-31 on **661 audited findings** out of 1837, every one labelled by opening its cited `file:line`. Methodology, the full label set and per-finding verdicts are in `BENCHMARKING_RESULTS.md`, `PRECISION_AUDIT_V4.md` and `PRECISION_AUDIT_V3.md`.
...
| Published precision (crypto findings) | 97.25% (661 audited rows, DEPENDS excluded) | ~49–76% (published benchmarks) | High (full data-flow) | Not published | Not published |
