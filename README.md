...
| Published precision (crypto findings) | 97.10% (630 audited rows, DEPENDS excluded) | ~49–76% (published benchmarks) | High (full data-flow) | Not published | Not published |
