...
**Current status, 2026-09-01, stated plainly against the target below:** the directory exists
with one planted file per language (7 files, 117 call sites, no adversarial or negative
subdirectories yet) and a working `recall_check.py` — **49.6% family-level recall (58/117)**,
