...
use quipuu_core::{Finding, Policy, QuantumStatus, Severity, severity_of};
...
impl AppState {
    ...
    pub fn apply_findings_filter(
        ...
        filter: &str,
        findings: &[Finding],
        algorithms: &quipuu_core::AlgorithmTable,
        policy: &Policy,
    ) {
...
pub struct Kpi {
    ...
    /// `quipuu_core::risk::apply_hndl_flags` is the one place the flag is
