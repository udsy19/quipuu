...
//! GitHub Advanced Security was the loudest. `quipuu_core::score_of` is now
...
fn tmp_tree(suffix: &str) -> PathBuf {
    let dir = std::env::temp_dir().join(format!("quipuu_artifact_agreement_{suffix}"));
