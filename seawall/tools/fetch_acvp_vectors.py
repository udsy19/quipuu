...
inside the seawall binary via `include_bytes!`. The compiled binary never
...
seawall's runner consumes a SINGLE merged file per (algorithm, parameterSet,
...
# (subset of parameter sets seawall's runner supports today)
TARGETS = [
    {
