...
use seawall_core::{AlgorithmRecord, AlgorithmTable, Finding, Primitive, QuantumStatus};
use thiserror::Error;
use uuid::Uuid;
...
pub fn emit_cbom(
    ...
    if !undetermined.is_empty() {
        ...
        eprintln!(
            "seawall: {} finding(s) had no resolvable algorithm and were omitted \
    ...
    let bom = Bom {
        ...
        metadata: Some(Metadata {
            ...
            tools: vec![Tool {
                vendor: Some("seawall".into()),
                name: "seawall".into(),
                version: env!("CARGO_PKG_VERSION").to_owned(),
            }],
            component: Some(Component {
                component_type: ComponentType::Application,
                bom_ref: Some("seawall/scan-target".into()),
