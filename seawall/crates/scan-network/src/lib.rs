//! seawall-scan-network — TLS endpoint probe.
//!
...
//!   * Cert-chain findings via the existing [`seawall_scan_certs`] crate.
//!   * One [`seawall_core::Finding`] per probe outcome (Accepted / Rejected / Timeout).
//!
