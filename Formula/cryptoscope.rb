# Formula/cryptoscope.rb — Homebrew formula for cryptoscope
#
...
class Cryptoscope < Formula
  ...
  def install
    bin.install "cryptoscope"
  end

  # ── Smoke test run by `brew test cryptoscope` ────────────────────────────
  test do
    assert_match version.to_s, shell_output("#{bin}/cryptoscope --version")
  end
end
